...
$box = imagettfbbox($font_size, 0, $font_path, $text_new);
//new text height
...
//add text to image
imagettftext($im, $font_size, 0, $margin+1, $font_size+$margin+1, $red, $font_path, $text_new);
imagettftext($im, $font_size, 0, $margin, $font_size+$margin, $black, $font_path, $text_new);


//***************imagettftext($grande, $font_size, 0, $margin, $font_size+$margin, $black, $font_path, $text_new);

//add text to image
//imagettftext($out, $font_size, 0, $margin, $font_size+$margin, $im, $font_path, $text_new);
